...
LinkedList<Integer> ll = new LinkedList<>();
		...
		System.out.println(ll.poll()); // 5 pollda siliyor delil olarak getiriyor listeyi bi daha yazdiðimizda 5 yok
		System.out.println(ll); // [7]
		
		System.out.println(ll.poll()); // 7  1. elementi hem silecek hemde bana geri dondurecek
		System.out.println(ll); // []
